...
public class RequestWrapper {
	/*
  El contenedor esta definido por 2 Listas que son uno a uno con los Json que manda la web
  para poder cominucar la informacion a travez del POST
	Ademas del Identificador unico del Frame y el JSon String correspondiente a la configuracion de la estructura
  */
		private String nameIdFrame;
		private List<Sentencia> listaSentencias;
		private List<ElementoPost> listaElementos;
		private String jsonConfig;


		public String getnameIdFrame(){
			return nameIdFrame;
		}

		public void sernameIdFrame(String nameIdFrame){
			this.nameIdFrame = nameIdFrame ;
		}
    ...
    public void setListaSentencias(List<Sentencia> s) {
		...
		public void serjsonConfig(String jsonConfig){
			this.jsonConfig = jsonConfig ;
		}

		@Override
    public String toString() {
        return "Contenedor{" + "nameFrame : " + this.nameIdFrame + ", elements=" + this.listaElementos + ", sentens=" + this.listaSentencias + ", jsonConfig :"+this.jsonConfig+'}';
    }
